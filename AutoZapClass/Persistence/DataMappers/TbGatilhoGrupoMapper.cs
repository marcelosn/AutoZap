...
{
    class TbGatilhoGrupoMapper : IDataMapper
    {
        private bool _isInitialized = false;

        private int _ordinal_groupid;
        private int _ordinal_tpserver;
        private int _ordinal_gatilho_id;
        ...
        public void PopulateOrdinals(IDataReader reader)
        {
            ...
            _ordinal_gatilho_id = reader.GetOrdinal("gatilho_id");
        ...
        public Object GetData(IDataReader reader)
        {
            ...
            TbGatilhoGrupo dto = new TbGatilhoGrupo();
            ...
            if (!reader.IsDBNull(_ordinal_gatilho_id)) { dto.gatilho_id = reader.GetInt32(_ordinal_gatilho_id); }
